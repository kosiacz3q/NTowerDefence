...
void CubeObject::init()
{
	...
	colorBufferData = new GLfloat[36 * 3]
	{
	...
	glBufferData(GL_ARRAY_BUFFER, 36 * 3 * sizeof(GLfloat), colorBufferData, GL_STATIC_DRAW);
...
void CubeObject::update(UpdateContextPtr updateContext)
{
